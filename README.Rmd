...
This repository is for development and testing of https://github.com/sinanpl/OaxacaBlinder .  Please use that package and not this one.  Branches in this repository, particularly `testing` and `master`, may be removed, replaced, or have their histories rewritten at any point.
